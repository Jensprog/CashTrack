        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-4 mb-6">
              ...
              {chartData.length > 0 && (
                <div className="mt-4">
                  <h3 className="text-md font-medium text-gray-800 dark:text-white mb-2">Utgiftsdetaljer</h3>
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-md">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Största utgiftskategori:</p>
                        <p className="text-lg font-semibold">
                          {chartData[0]?.name} ({formatValue(displayMode === 'amount' ? chartData[0]?.value : chartData[0]?.percent)})
                        </p>
                      </div>
                    </div>
                  </div>
