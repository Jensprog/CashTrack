      ...
      <section className="flex-grow flex flex-col md:flex-row items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
        <div className="md:w-1/2 md:pr-8">
          ...
          <p className="mt-4 text-xl text-gray-600 dark:text-gray-300">
            CashTrack hjälper dig hålla koll på dina inkomster och utgifter mellan de datum som
            passar dig. Få bättre översikt och ta kontrollen över din ekonomi.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Få detaljerade vecko- och månadsöversikter som gör det enkelt att förstå dina
                ekonomiska mönster.
              </p>
            </div>
          </div>
